...
<body>
    <form method="POST" action="{{ route('admin.register.submit') }}" class="form-container">
        @csrf
        <div class="logo">
    ...
    <div id="passwordMatchMessage"  class="passwordMatchMessage-indicator"></div>
        ...
        <div>
            <p><a href="{{ route('AdminLogin') }}">Login Here ></a></p>
        </div>
    </form>
...
<script>
    ...
    function handleRegisterButtonClick(event) {
        ...
        fetch('{{ route("admin.check_email") }}?email=' + email)
                            ...
                            .then(response => {
                                if (response.ok) {
                                    ...
                                    Swal.fire({
                                        ...
                                        // Redirect to AdminLogin route after clicking OK
