...
<section id="content">
    ...
    <nav>
			...
			<div class="title-form"><img width="25" height="25" src="https://img.icons8.com/color-glass/48/000000/gender-neutral-user.png" alt="gender-neutral-user"/>&ensp;&nbsp;PROFILE</div>
            <div class="welcome-message">
            <p>Welcome, {{ $user->position }}! {{ $user->firstname }}</p>
            </div>
            <div class="profile-pictureupper">
                <div class="image-holder"></div>
                <img id="profilePicturePreview" src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('images/Defaultprofile-modified.png') }}" alt="Profile Picture">
            </div>
                        ...
                        <div class="details-personal">
                            <div class="fields-profile">
                                ...
                                <div class="input-field">
                                    ...
                                    <input type="text" id="position" name="position" value="{{ $user->position }}" disabled>
                                </div>
                                <div class="input-field">
                    ...
                    <div class="details-personal">
                        <div class="fields-profile">
                            <div class="input-field">
                                ...
                                <input type="text" id="firstnamee" name="firstnamee" value="{{ $user->firstname }}">
                            </div>
                            <div class="input-field">
                                <label for="lastnamee">Last Name: </label>
                                <input type="text" id="lastnamee" name="lastnamee" value="{{ $user->lastname }}">
                            </div>
                            <div class="input-field">
                                <label for="positionn">Position: </label>
                                <select id="positionn" name="positionn">
                            ...
                            <div class="input-field">
                                ...
                                <input type="email" id="emaill" name="emaill" value="{{ $user->email }}">
                            </div>
                        </div>
                    </div>
                </div>
...
function updateProfile() {
    ...
    var position = document.getElementById('positionn').value;
    ...
    if (email !== originalEmail) {
        ...
        .then(data => {
            if (!data.unique) {
                ...
                sendUpdateRequest(firstname, lastname, position, email);
            }
        })
        .catch(error => {
            // Display an error message using Sweet Alert
...
function sendUpdateRequest(firstname, lastname, position, email) {
